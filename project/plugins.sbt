...
addSbtPlugin("org.typelevel" % "sbt-typelevel-github" % "0.6.4")
addSbtPlugin("org.typelevel" % "sbt-typelevel-versioning" % "0.6.4")
...
addSbtPlugin("org.typelevel" % "sbt-typelevel-kernel" % "0.6.4")
