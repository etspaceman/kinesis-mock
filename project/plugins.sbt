...
addSbtPlugin("org.typelevel" % "sbt-typelevel-github" % "0.8.1")
addSbtPlugin("org.typelevel" % "sbt-typelevel-versioning" % "0.8.1")
addSbtPlugin("org.typelevel" % "sbt-typelevel-ci" % "0.8.1")
addSbtPlugin("org.typelevel" % "sbt-typelevel-site" % "0.8.1")
addSbtPlugin("org.typelevel" % "sbt-typelevel-mergify" % "0.8.1")
addSbtPlugin("org.typelevel" % "sbt-typelevel-kernel" % "0.8.1")
