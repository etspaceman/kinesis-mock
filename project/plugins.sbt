...
addSbtPlugin("org.typelevel" % "sbt-typelevel-github" % "0.5.0-RC10")
addSbtPlugin("org.typelevel" % "sbt-typelevel-versioning" % "0.5.0-RC10")
...
addSbtPlugin("org.typelevel" % "sbt-typelevel-kernel" % "0.5.0-RC10")
