...
addSbtPlugin("org.typelevel" % "sbt-typelevel-github" % "0.5.2")
addSbtPlugin("org.typelevel" % "sbt-typelevel-versioning" % "0.5.2")
...
addSbtPlugin("org.typelevel" % "sbt-typelevel-kernel" % "0.5.2")
