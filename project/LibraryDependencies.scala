...
object LibraryDependencies {
  ...
  val UUIDCreator = "com.github.f4b6a3" % "uuid-creator" % "4.6.0"
  ...
  object Aws {
    ...
    val kpl = "com.amazonaws" % "amazon-kinesis-producer" % "0.14.11"
    val kcl = "software.amazon.kinesis" % "amazon-kinesis-client" % "2.4.0"
  }
