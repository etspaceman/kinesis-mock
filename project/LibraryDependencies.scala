...
object LibraryDependencies {
  ...
  val UUIDCreator = "com.github.f4b6a3" % "uuid-creator" % "4.1.2"
  ...
  object Aws {
    ...
    val kpl = "com.amazonaws" % "amazon-kinesis-producer" % "0.14.9"
    val kcl = "software.amazon.kinesis" % "amazon-kinesis-client" % "2.3.7"
  }
