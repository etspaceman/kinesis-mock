      ...
      case KinesisAction.AddTagsToStream =>
        request
          ...
          .foldF(
            ...
            req =>
              cache
                .addTagsToStream(req, loggingContext, isCbor, region, accountId)
                .flatMap(
                  _.fold(
      ...
      case KinesisAction.CreateStream =>
        request
          ...
          .foldF(
            ...
            req =>
              cache
                .createStream(req, loggingContext, isCbor, region, accountId)
                .flatMap(
                  _.fold(
                    err => handleKinesisMockError(err, responseHeaders),
                    _ => emptyOk(responseHeaders, contentType)
      ...
      case KinesisAction.DeleteStream =>
        request
          ...
          .foldF(
            ...
            req =>
              cache
                .deleteStream(req, loggingContext, isCbor, region, accountId)
                .flatMap(
                  _.fold(
                    err => handleKinesisMockError(err, responseHeaders),
                    _ => emptyOk(responseHeaders, contentType)
      ...
      case KinesisAction.DescribeStream =>
        request
          ...
          .foldF(
            ...
            req =>
              cache
                .describeStream(req, loggingContext, isCbor, region, accountId)
                .flatMap(
                  _.fold(
                    err => handleKinesisMockError(err, responseHeaders),
                    res => Ok(res, responseHeaders*)
      ...
      case KinesisAction.GetRecords =>
        request
          ...
          .foldF(
            ...
            req =>
              cache
                .getRecords(req, loggingContext, isCbor, region, accountId)
                .flatMap(
                  _.fold(
                    err => handleKinesisMockError(err, responseHeaders),
                    res => Ok(res, responseHeaders*)
      ...
      case KinesisAction.ListShards =>
        request
          ...
          .foldF(
            ...
            req =>
              cache
                .listShards(req, loggingContext, isCbor, region, accountId)
                .flatMap(
                  _.fold(
                    err => handleKinesisMockError(err, responseHeaders),
                    res => Ok(res, responseHeaders*)
      ...
      case KinesisAction.ListStreams =>
        request
          ...
          .foldF(
            ...
            req =>
              cache
                .listStreams(req, loggingContext, isCbor, region, accountId)
                .flatMap(
                  _.fold(
                    err => handleKinesisMockError(err, responseHeaders),
                    res => Ok(res, responseHeaders*)
      ...
      case KinesisAction.MergeShards =>
        request
          ...
          .foldF(
            ...
            req =>
              cache
                .mergeShards(req, loggingContext, isCbor, region, accountId)
                .flatMap(
                  _.fold(
                    err => handleKinesisMockError(err, responseHeaders),
                    _ => emptyOk(responseHeaders, contentType)
      ...
      case KinesisAction.PutRecord =>
        request
          ...
          .foldF(
            ...
            req =>
              cache
                .putRecord(req, loggingContext, isCbor, region, accountId)
                .flatMap(
                  _.fold(
                    err => handleKinesisMockError(err, responseHeaders),
                    res => Ok(res, responseHeaders*)
      ...
      case KinesisAction.PutRecords =>
        request
          ...
          .foldF(
            ...
            req =>
              cache
                .putRecords(req, loggingContext, isCbor, region, accountId)
                .flatMap(
                  _.fold(
                    err => handleKinesisMockError(err, responseHeaders),
                    res => Ok(res, responseHeaders*)
      ...
      case KinesisAction.SplitShard =>
        request
          ...
          .foldF(
            ...
            req =>
              cache
                .splitShard(req, loggingContext, isCbor, region, accountId)
                .flatMap(
                  _.fold(
                    err => handleKinesisMockError(err, responseHeaders),
                    _ => emptyOk(responseHeaders, contentType)
